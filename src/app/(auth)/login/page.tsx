      ...
      <div className="hidden lg:flex lg:w-1/2 ocean-gradient items-center justify-center relative overflow-hidden">
        <div className="text-white text-center z-10 px-12">
          ...
          <p className="text-ocean-200 text-lg leading-relaxed">
            Platfòm pou lwe bato pi bon an. Jwenn bato rèv ou a oubyen mete pa ou pou touche lajan.
          </p>
        </div>
        {/* Decorative waves */}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="text-right mt-1">
                <Link href="/forgot-password" className="text-xs text-ocean-600 hover:underline">Modpas bliye?</Link>
              </div>
            </div>
